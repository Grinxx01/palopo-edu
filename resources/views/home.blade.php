            ...
            <div class="d-flex justify-content-md-end">
                <div class="btn-group" role="group">
                    ...
                    @foreach($educationLevels as $level)
                        <a href="{{ route('home', ['level' => $level->id]) }}"
                           class="btn {{ $levelId == $level->id ? 'btn-primary' : 'btn-outline-primary' }}">
                            {{ $level->code }}
                        </a>
                    @endforeach
                </div>
            ...
            <div class="col-md-6 col-lg-4 institution-card">
                <div class="card h-100">
                    <div class="position-relative">
                        ...
                        @endif
                        <span class="badge institution-type-badge badge-{{ strtolower($institution->educationLevel->code ?? 'default') }}">
                            {{ $institution->educationLevel->code ?? 'N/A' }}
                        </span>
                    </div>
                    <div class="card-body">
